...
import TileAndGroutGallery from "./Sections/Gallery/TileAndGroutGallery";
import TileAndGroutDescription from "./Sections/Description/TileAndGroutDescription";
import Filler from "./Sections/Contact/Filler";

const useStyles = makeStyles(aboutUsStyle);

export default function TileAndGrout() {
  React.useEffect(() => {
    window.scrollTo(0, 0);
      ...
      <Parallax image={require("assets/img/sections/mainPage/tileGrout.jpg")} filter="dark" small>
        <div className={classes.container}>
          <GridContainer justify="center">
            ...
            >
              <h1 className={classes.title}>Tile & Grout Cleaning</h1>
            </GridItem>
          </GridContainer>
        </div>
      </Parallax>
